import { View,Text,SafeAreaView,TextInput,FlatList,Button,TouchableOpacity,Alert,StyleSheet} from 'react-native'
...
export default function App() {
  ...
  <View style={styles.container}>
    <SafeAreaView style={styles.container}>
      <Text>React Native AsyncStorage</Text>
...
const styles = StyleSheet.create({
  ...
  input: {flex: 1, marginRight: 10, borderWidth: 1,}
